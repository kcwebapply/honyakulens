...
public struct SlideMenuOptions {
   // public static var leftViewWidth: CGFloat = 270.0
     public static var leftViewWidth: CGFloat = 320
        ...
        if (SlideMenuOptions.hideStatusBar) {
            DispatchQueue.main.async(execute: {
                if let window = UIApplication.shared.keyWindow {
                    ...
                    window.windowLevel = UIWindowLevelStatusBar+1 //UIWindowLevelStatusBar + 1
                }
            })
        }
    }
...
extension UIViewController {
    ...
    public func toggleLeft() {
        ...
        //var secondView = storyboard.instantiateViewControllerWithIdentifier("Third") as! ThirdSwift
       // let nvc: UINavigationController = UINavigationController(rootViewController: mainViewController)
        ...
        // nvc.navigationItem.setLeftBarButtonItem(myBarButton_3, animated: true)
        
        // let backButtonItem = UIBarButtonItem(title: "ほげ", style: .Plain, target: nil, action: nil)
        // nvc.navigationItem.backBarButtonItem = backButtonItem
        ...
        var second :  UINavigationController = UINavigationController(rootViewController:secondView)
